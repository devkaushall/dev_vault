...
| 41 | Admin screens (14) | `Admin/Screens/*` | COMPLETE | integration | Every screen renders markup, throws nothing, uses no jargon |
...
| 51 | Documentation | `README.md`, `docs/*` | COMPLETE | manual | Nine documents including this matrix |
| 52 | No Composer / ACF / React / Elasticsearch | whole tree | COMPLETE | integration | Custom autoloader; boots with nothing installed |
| 53 | Change requests from the field | `Field/Requests.php`, `Screens/RequestsScreen.php`, `ListingsScreen::propose()` | COMPLETE | integration (`it-31`) | Propose/approve/decline, capability split, note-to-record, mail opt-in; **never opened in a real browser** |
