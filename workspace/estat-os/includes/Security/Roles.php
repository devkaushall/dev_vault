...
final class Roles {
	...
	public static function all(): array {
		return array(
			...
			'estat_request_listings'    => __( 'Ask the office to change a property that belongs to somebody else', 'estat-os' ),
			'estat_review_listings'     => __( 'Approve or turn down changes proposed from the field', 'estat-os' ),
		);
	}
