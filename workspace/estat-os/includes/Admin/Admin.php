...
final class Admin {
	...
	public function register(): void {
		$this->screens = array(
			...
			'estat-requests'    => array( Screens\RequestsScreen::class, 'render' ),
	...
	public function add_menu(): void {
		...
		$pages = array(
			...
			// Both halves of one job: the office reviews here, an agent follows
			// up what they asked for. Whichever half a person sees is decided by
			// what they may do, not by a second menu entry.
			array( 'estat-requests', __( 'Change Requests', 'estat-os' ), 'estat_request_listings' ),
