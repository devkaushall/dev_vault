...
final class Partials {
	...
	public static function header( string $page, bool $wide = false ): void {
		$titles = array(
			...
			'estat-requests'    => array( __( 'Change Requests', 'estat-os' ), __( 'Things your team saw on the ground that the website has wrong.', 'estat-os' ) ),
	...
	public static function notices(): void {
		...
		$messages = array(
			...
			'requested'        => array( 'success', __( 'Sent. Nothing on the website has changed yet — somebody in the office has to say yes first.', 'estat-os' ) ),
			'request_approved' => array( 'success', __( 'Approved. The property has been updated and the website now shows the change.', 'estat-os' ) ),
			'request_declined' => array( 'success', __( 'Turned down. The property was left exactly as it is, and your agent sees why.', 'estat-os' ) ),
