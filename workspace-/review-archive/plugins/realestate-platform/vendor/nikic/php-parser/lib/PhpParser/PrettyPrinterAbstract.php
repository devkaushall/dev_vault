...
abstract class PrettyPrinterAbstract implements PrettyPrinter {
	...
	protected array $precedenceMap = array(
		...
		BinaryOp\Pipe::class           => array( 65, 66, 65 ),
		...
		Expr\Cast\Void_::class         => array( 250, -1, -1 ),
	);
	...
	protected function initializeModifierChangeMap(): void {
		...
		$this->modifierChangeMap = array(
			Stmt\ClassConst::class . '->flags'           => array( 'pModifiers', \T_WHITESPACE, \T_CONST ),
			Stmt\ClassMethod::class . '->flags'          => array( 'pModifiers', \T_WHITESPACE, \T_FUNCTION ),
			Stmt\Class_::class . '->flags'               => array( 'pModifiers', \T_WHITESPACE, \T_CLASS ),
			Stmt\Property::class . '->flags'             => array( 'pModifiers', \T_WHITESPACE, \T_VARIABLE ),
			PrintableNewAnonClassNode::class . '->flags' => array( 'pModifiers', \T_NEW, \T_CLASS ),
			Param::class . '->flags'                     => array( 'pModifiers', \T_WHITESPACE, \T_VARIABLE ),
			PropertyHook::class . '->flags'              => array( 'pModifiers', \T_WHITESPACE, \T_STRING ),
			Expr\Closure::class . '->static'             => array( 'pStatic', \T_WHITESPACE, \T_FUNCTION ),
			Expr\ArrowFunction::class . '->static'       => array( 'pStatic', \T_WHITESPACE, \T_FN ),
